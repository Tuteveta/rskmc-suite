...
import { BookOpen, ClipboardList, Cross, DollarSign, Droplets, HardDrive, Heart, LayoutGrid, Package, Users } from 'lucide-react';
...
const financialNavItems: NavItem[] = [{ title: 'Tithes & Offerings', url: '/tithes', icon: DollarSign }];

const assetsNavItems: NavItem[] = [{ title: 'Assets', url: '/assets', icon: Package }];
