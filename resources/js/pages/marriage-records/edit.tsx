...
interface Record {
    id: number;
    husband_member_id: number | null;
    wife_member_id: number | null;
...
export default function MarriageRecordEdit({ record }: { record: Record; members?: Member[] }) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('marriage-records.update', record.id));
    };
    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-2xl p-4 sm:p-6">
                <h1 className="mb-6 text-2xl font-semibold">Edit Marriage Record</h1>
